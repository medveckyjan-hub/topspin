...
export type TournamentGroup={id:string;name:string;entryIds:string[];matches:Match[];qualifiers:number;bestOf:3|5|7};
...
export type Competition={id:string;name:string;type:CompetitionType;bestOf:3|5|7;preferredSize:number;qualifiersPerGroup:number;thirdPlace:boolean;consolation:boolean;entryIds:string[];groups:TournamentGroup[];ko:Knockout;teamSystemId?:TeamSystemId;teamTies:TeamTie[]};
