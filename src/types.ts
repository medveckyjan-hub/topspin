...
export type Competition={id:string;name:string;type:CompetitionType;bestOf:3|5|7;preferredSize:number;qualifiersPerGroup:number;thirdPlace:boolean;consolation:boolean;groupPlayoff:boolean;entryIds:string[];groups:TournamentGroup[];ko:Knockout;teamSystemId?:TeamSystemId;teamTies:TeamTie[]};
...
export type View='dashboard'|'players'|'entries'|'competitions'|'groups'|'results'|'knockout'|'schedule'|'teams'|'exports';
