...
-- Východiskový stav databázy TOPSPIN.
--
-- Obsahuje kompletnú schému: tabuľky, RLS, security-definer funkcie,
-- oprávnenia a storage bucket. Je idempotentná — dá sa spustiť opakovane.
-- Na existujúcej databáze ju stačí spustiť raz; ďalšie zmeny už patria
-- do samostatných migrácií, nikdy nie do tohto súboru.
-- ════════════════════════════════════════════════════════════════
...
begin
  ...
  values (
    p_slug, btrim(p_first), btrim(p_last), coalesce(p_club,''), p_year, p_license,
