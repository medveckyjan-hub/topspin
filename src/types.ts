...
export type View='dashboard'|'players'|'database'|'registration'|'history'|'entries'|'competitions'|'groups'|'results'|'qualification'|'knockout'|'schedule'|'order'|'teams'|'exports';
