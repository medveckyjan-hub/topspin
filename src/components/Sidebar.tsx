import { Shuffle, LayoutDashboard, Users, UserRoundCog, Trophy, Layers3, TableProperties, GitBranch, CalendarClock, Medal, Database, UserPlus, RotateCcw, Shield, FileDown } from 'lucide-react';
