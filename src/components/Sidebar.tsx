import { Layers, Shuffle, LayoutDashboard, Users, UserRoundCog, Trophy, Layers3, TableProperties, GitBranch, CalendarClock, Medal, Database, UserPlus, RotateCcw, Shield, FileDown } from 'lucide-react';
...
const items: [View, string, any][] = [
  ...
  ['stages', 'Fázy turnaja', Layers],
  ['qualification', 'Kvalifikácia', Shuffle],
